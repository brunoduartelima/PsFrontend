            ...
            <header>
                <div className="content-header">
                    ...
                    <form onSubmit={handleLogin}>
                        ...
                        <div>
                        <label>E-mail</label>
                        <input name="email" type="email" value={emailLogin} onChange={e => setEmailLogin(e.target.value)}/>
                        </div>

                        <div>
                        <label>Senha</label>
                        <input name="password" type="password" value={passwordLogin} onChange={e => setPasswordLogin(e.target.value)}/>
                        </div>
